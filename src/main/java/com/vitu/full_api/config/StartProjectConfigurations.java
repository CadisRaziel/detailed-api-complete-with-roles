...
@RequiredArgsConstructor //-> todos os atributos que tiverem como 'final' serão injetados automaticamente sem a necessidade do @AutoWired. (ou seja 'UserRepository' , 'RoleRepository' e 'PasswordEncoder')
