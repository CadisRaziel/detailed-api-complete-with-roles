package com.vitu.full_api.entity;
...
public class User implements UserDetails {    //UserDetails -> Interface do Spring Security que representa um usuário.
    ...
    @Setter(AccessLevel.NONE) //-> impede que seja alterado depois de criado
    private LocalDateTime registrationMoment;

    @ManyToMany(fetch = FetchType.EAGER) // Relacionamento muito para muitos. (EAGER -> sempre que eu carrega o usuario vai carregar a lista de roles associados a ele)
